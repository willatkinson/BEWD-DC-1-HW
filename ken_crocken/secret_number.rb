...
# One this that wasn't accounted for is if the user gets the correct guess on the
...
# That way in your loop your could either puts sec_number(player_guess,guesses) or check for a return follow
